...
//    }
    ...
    public function okfnwp_mailinglist_action_callback() {
        ...
        ?>
        <p><?php _e('URL to which the subscribe form data will be sent. Mailman example: http://lists.okfn.org/mailman/subscribe/XYZ'); ?></p>
        <?php
    }
    ...
    public function okfnwp_mailinglist_id_callback() {
        ...
        ?>
        <p><?php _e('For the list at http://lists.okfn.org/mailman/subscribe/XYZ, this should be XYZ'); ?></p>
        <?php
    }
